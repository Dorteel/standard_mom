...
def main():
    ...
    _, clusters = bot.pcl.get_cluster_positions(ref_frame="locobot/arm_base_link", sort_axis="y", reverse=True)
    ...
    for cluster in clusters:
        ...
        bot.arm.set_ee_pose_components(x=x, y=y+0.01, z=z+0.05, pitch=0.5)
        bot.arm.set_ee_pose_components(x=x, y=y+0.01, z=z-0.05, pitch=0.5)
        bot.gripper.close()
